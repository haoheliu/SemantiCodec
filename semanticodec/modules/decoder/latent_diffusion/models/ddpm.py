...
# from semanticodec.modules.decoder.latent_diffusion.modules.encoders.modules import *
import datetime
...
class DDPM(pl.LightningModule):
    ...
    def get_validation_folder_name(self):
        ...
        return "val_%s_%s_cfg_scale_%s_ddim_%s_n_cand_%s" % (self.global_step, timestamp, self.evaluation_params["unconditional_guidance_scale"], self.evaluation_params["ddim_sampling_steps"], self.evaluation_params["n_candidates_per_samples"])
